...
const Footer: React.FC = () => {
  return (
    <footer className="bg-white pt-20 pb-0 overflow-hidden font-dm-sans border-t border-gray-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-4 flex flex-col gap-8">
            ...
            <div className="flex gap-3">
              <a href="#" className="w-8 h-8 rounded-full bg-[#1B3A6B] flex items-center justify-center text-white hover:bg-opacity-90 transition-all">
                <Instagram size={16} />
              </a>
              <a href="#" className="w-8 h-8 rounded-full bg-[#1B3A6B] flex items-center justify-center text-white hover:bg-opacity-90 transition-all">
                <Linkedin size={16} />
          ...
          <div className="lg:col-span-3 lg:pl-10">
            ...
            <ul className="flex flex-col gap-6 text-[15px] font-medium text-[#1a1a1a]/70">
              <li><Link to="/news" className="hover:text-[#1B3A6B] transition-colors">News</Link></li>
              <li><Link to="/races" className="hover:text-[#1B3A6B] transition-colors">Upcoming event</Link></li>
              <li><Link to="/races" className="hover:text-[#1B3A6B] transition-colors">Events calendar</Link></li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="flex flex-col gap-6 text-[15px] font-medium text-[#1a1a1a]/70">
              <li><Link to="/about" className="hover:text-[#1B3A6B] transition-colors">About us</Link></li>
              <li><Link to="/about" className="hover:text-[#1B3A6B] transition-colors">Vision</Link></li>
            </ul>
          </div>

          {/* Column 4: Help Center (takes 3 cols) */}
          <div className="lg:col-span-3">
            <h3 className="text-xl font-bold text-[#1B3A6B] mb-8">Help Center</h3>
            <ul className="flex flex-col gap-6 text-[15px] font-medium text-[#1a1a1a]/70">
              <li><Link to="/contact" className="hover:text-[#1B3A6B] transition-colors">Contact us</Link></li>
              <li><Link to="/faq" className="hover:text-[#1B3A6B] transition-colors">FAQs</Link></li>
            </ul>
          </div>
        </div>
      </div>
      ...
      {/* Bottom Bar */}
      <div className="bg-[#1B3A6B] py-5 text-center">
