...
const EventsCalendar: React.FC = () => {
  ...
  return (
    <section
      className="py-20 text-white overflow-hidden rounded-t-[60px] -mt-16 relative z-20"
      style={{
        background:
    ...
    >
      <div className="w-full max-w-[1728px] mx-auto px-6 xl:px-[77px]">
        <div className="text-center mb-10">
          <Title dark={false} className="section-heading mb-3">
            Events Calendar
          </Title>
          <p className="font-medium text-[15px] leading-none tracking-tightest text-white/60">
        ...
        <div className="flex justify-center mb-12">
          <div className="inline-flex items-center bg-white rounded-full px-2 py-2 border border-white/10 gap-2">
            <button className="flex items-center gap-2 px-5 py-2 border border-gray-200 rounded-full text-[#333] text-sm font-medium transition-all hover:bg-gray-50">
              <Calendar size={15} className="text-gray-400" /> Season{" "}
            ...
            <button className="flex items-center gap-2 px-5 py-2 border border-gray-200 rounded-full text-[#333] text-sm font-medium transition-all hover:bg-gray-50">
              ...
              Event <ChevronDown size={13} className="text-gray-400" />
            </button>
          </div>
        </div>

        {/* Featured Image */}
        <div className="max-w-3xl mx-auto relative aspect-video rounded-[40px] overflow-hidden mb-12 shadow-2xl border-2 border-white/5">
          <img
            src={FeaturedEvent}
